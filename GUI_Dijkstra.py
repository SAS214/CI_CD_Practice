...
def printCost(cost,letters,source): #printing the last result

    myWindow = [Label(root)]

    myWindow2 = Label(root, text = 'Distance from the source to point:')
    myWindow2.grid(row = 0, column= 7,pady=2)
...
def readData():
    ...
    try:
        ...
        print('Please type a valid source')
